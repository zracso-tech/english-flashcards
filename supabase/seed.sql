-- Seed: 75 tarjetas iniciales (las del widget original)

insert into public.cards (word, meaning, example, module) values
-- W1 Sounding Native
...
-- W1 Mastering Sounds — Flap T words
